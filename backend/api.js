...
const url = `mongodb://linux-api:${password}@linux-api.mongo.cosmos.azure.com:10255/?ssl=true&retrywrites=false&maxIdleTimeMS=120000&appName=@linux-api@`;
...
app.post("/api/persons/", (req, res) => {
  ...
  if (!person.name)
    return res.status(400).json({
      ...
      message:
        "O campo nome não pode ser vazio, e deve conter no minimo 3 caracteres",
    });
